...
public class EnemyAI : MonoBehaviour
{
    ...
    [SerializeField] private float _chasingSpeedMultipliyer = 2f;
    ...
    private void Awake()
    {
        ...
        _chasingSpeed = _navMeshAgent.speed * _chasingSpeedMultipliyer;
    }
    private void Update()
    {
        StateHandler();
    ...
    private void Roaming()
    {
        ...
        ChangeFacingDirection(_staringPosition, _roamPosition);
        _navMeshAgent.SetDestination(_roamPosition);
    }

    private Vector3 GetRoamingPosition()
    {
        return _staringPosition + Utils.GetRandomDir() * UnityEngine.Random.Range(_roamingDistanceMin, _roamingDistanceMax);
    }
